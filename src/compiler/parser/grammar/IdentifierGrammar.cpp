...
#include <unilang/compiler/parser/grammar/IdentifierGrammarDef.hpp>
...
template struct unilang::parser::SIdentifierGrammar<TSourceCodeIterator, TLexerTokenIterator>;
