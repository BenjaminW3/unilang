...
#include <unilang/compiler/parser/grammar/StatementGrammarDef.hpp>
...
template struct unilang::parser::SStatementGrammar<TSourceCodeIterator, TLexerTokenIterator>;
