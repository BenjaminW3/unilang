...
{ 
	namespace execution_engine
	{
		...
		//
		//-------------------------------------------------------------------------
		int64_t executeModule( llvm::Module const & module )
		{
			...
			funcDecl.m_bHasUnpureQualifier = true;
			funcDecl.m_idfName.m_sName = "entrypoint";
			ast::SVariableDeclaration var;
			var.m_type.m_idfName = ast::SIdentifier("i64");
			funcDecl.m_vReturnDeclarations.emplace_back(var);
